...
var index_config_default = {
  ...
  pans: {
   ...
   danmu: {
    urls: [
           { address: "https://logdanmu.dpdns.org", name: "榛樿1" },
           { address: "https://fjj0417.dpdns.org/87654321", name: "榛樿2" }, 
           { address: "https://dm.stardm.us.kg:443/87654321", name: "榛樿3" }, 
           { address: "https://danmu.14812910.xyz/87654321", name: "榛樿4" }, 
           { address: "https://313236.xyz/87654321", name: "榛樿5" }
          ],
    autoPush: true
  },
 t4: {list: [
    {name: "馃敒鑱氬悎浼犲獟",
      address: "https://php.doube.eu.org/spider/php/楹昏眴.php"}
]},
  cms: {list: [
  {name: "馃敒婊存淮", address: "https://api.ddapi.cc/api.php/provide/vod"},
  {name: "馃敒楦″潳", address: "https://jkunzyapi.com/api.php/provide/vod"},
  {name: "馃敒TG璧勬簮", address: "https://tgzyz.pp.ua/api.php/provide/vod"},
  {name: "馃敒瓒婂崡", address: "https://vnzyz.com/api.php/provide/vod"},
  {name: "馃敒濂ユ柉鍗�", address: "https://aosikazy4.com/api.php/provide/vod"},
  {name: "馃敒X缁嗚優", address: "https://www.xxibaozyw.com/api.php/provide/vod"},
  {name: "馃敒澶уザ瀛�", address: "https://apidanaizi.com/api.php/provide/vod"},
  {name: "馃敒绮惧搧X", address: "https://www.jingpinx.com/api.php/provide/vod"},
  {name: "馃敒鑰佽壊p", address: "https://apilsbzy1.com/api.php/provide/vod"},
  {name: "馃敒鐣彿", address: "http://fhapi9.com/api.php/provide/vod"},
  {name: "馃敒榛勮壊浠撳簱", address: "https://hsckzy888.com/api.php/provide/vod/from/hsckm3u8/at/json"},
  {name: "馃敒鐧捐姳", address: "https://bhziyuan.com/api.php/provide/vod/?ac=list"},
  {name: "馃敒杈ｆ", address: "http://lajiaozy.com/api.php/provide/vod"},
  {name: "馃敒155", address: "https://155api.com/api.php/provide/vod"},
  {name: "馃敒鏉忓惂", address: "https://xingba111.com/api.php/provide/vod/?ac=list"},
  {name: "馃敒鐜夊厰", address: "https://apiyutu.com/api.php/provide/vod"},
  {name: "馃敒AIvin", address: "http://lbapiby.com/api.php/provide/vod/at/json"},
  {name: "馃敒涔愭挱", address: "https://lbapi9.com/api.php/provide/vod"},
  {name: "馃敒濂堕棣�", address: "https://naixxzy.com/api.php/provide/vod"},
  {name: "馃敒妫灄", address: "http://slapibf.com/api.php/provide/vod"},
  {name: "馃敒鐣寗", address: "https://fqzy.me//api.php/provide/vod/?ac=list"},
  {name: "馃敒椴ㄩ奔", address: "https://shayuapi.com/api.php/provide/vod"},
  {name: "馃敒91楹昏眴", address: "http://91md.me/api.php/provide/vod"},
  {name: "馃敒CK鐧捐揣", address: "https://ckbh1.xyz/api.php/provide/vod/?ac=list"},
  {name: "馃敒妗冭姳", address: "https://thzy1.me/api.php/provide/vod/?ac=list"},
  {name: "馃敒璞嗚眴", address: "https://doudouzy.com/api.php/provide/vod/?ac=list"},
  {name: "馃敒鑹茬尗", address: "http://caiji.semaozy.net/inc/apijson_vod.php"},
  {name: "馃敒榛戞枡X", address: "https://www.heiliaozyapi.com/api.php/provide/vod/?ac=list"},
  {name: "馃敒棣欒晧", address: "https://www.xiangjiaozyw.com/api.php/provide/vod/?ac=list"},
  {name: "馃敒鐧句竾", address: "https://api.bwzyz.com/api.php/provide/vod/at/json"}
]},
  alist: [
    {
      name: "馃悏绁炴棌涔濆笣",
